...
import {
  ...
  bannerPostModel,
  bannerPutModel,
} from "./banner.model.js";

export const bannerPostController = async (c: Context) => {
  try {
...
export const bannerPutController = async (c: Context) => {
  try {
...
export const bannerDeleteController = async (c: Context) => {
  try {
    const params = c.get("params");
...
export const bannerGetController = async (c: Context) => {
  try {
