...
import {
  proofGetController,
  proofVideoDeleteController,
  proofVideoGetController,
  proofVideoPostController,
} from "./proof.controller.js";
import {
  packagePostMiddleware,
  proofVideoDeleteMiddleware,
  proofVideoMiddleware,
  proofVideoPostMiddleware,
} from "./proof.middleware.js";
