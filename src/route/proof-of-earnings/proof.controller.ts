...
import {
  proofGetModel,
  proofVideoDeleteModel,
  proofVideoGetModel,
  proofVideoPostModel,
} from "./proof.model.js";

export const proofGetController = async (c: Context) => {
  try {
...
export const proofVideoGetController = async (c: Context) => {
  try {
...
export const proofVideoPostController = async (c: Context) => {
  try {
...
export const proofVideoDeleteController = async (c: Context) => {
  try {
    const params = c.get("params");
