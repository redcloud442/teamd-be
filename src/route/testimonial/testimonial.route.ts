...
import {
  testimonialGetController,
  testimonialPostController,
  testimonialPutController,
} from "./testimonial.controller.js";
import {
  testimonialGetMiddleware,
  testimonialPostMiddleware,
  testimonialPutMiddleware,
} from "./testimonial.middleware.js";
