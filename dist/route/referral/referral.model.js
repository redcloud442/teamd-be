...
export const referralDirectModelPost = async (params) => {
    const { page, limit, search, columnAccessor, isAscendingSort, teamMemberProfile, date, } = params;
...
export const newReferralModelPost = async (params) => {
    ...
    const formattedDirectReferrals = directReferrals.map((referral) => {
        return {
            package_ally_bounty_log_id: referral.company_member_table.user_table.user_id,
