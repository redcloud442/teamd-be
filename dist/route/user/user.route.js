...
import { userActiveListController, userChangePasswordController, userGenerateLinkController, userGetByIdUserProfileController, userGetController, userGetSearchController, userListController, userListReinvestedController, userPatchController, userPostController, userProfileGetController, userProfilePutController, userProfileUpdateController, userPutController, userReferralController, userSponsorController, userTreeController, } from "./user.controller.js";
import { userActiveListMiddleware, userChangePasswordMiddleware, userGenerateLinkMiddleware, userGetByIdUserProfileMiddleware, userGetMiddleware, userGetSearchMiddleware, userListMiddleware, userListReinvestedMiddleware, userPatchMiddleware, userPostMiddleware, userProfileGetMiddleware, userProfilePutMiddleware, userProfileUpdateMiddleware, userPutMiddleware, userReferralMiddleware, userSponsorMiddleware, userTreeMiddleware, } from "./user.middleware.js";
const user = new Hono();
...
user.get("/:id/user-profile", userGetByIdUserProfileMiddleware, userGetByIdUserProfileController);
user.put("/:id/update-profile", userProfileUpdateMiddleware, userProfileUpdateController);
